 ...
 * @method static GenericRuleSet custom(string|\Illuminate\Contracts\Validation\Rule $customRule) The field under validation must pass custom validation rule.
